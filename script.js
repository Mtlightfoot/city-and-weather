// Function to find users current location, if statement for if they have location allowed or not
    ...
    navigator.geolocation.getCurrentPosition(position => {
        ...
        fetch(queryUrlCityName)
            ...
            .then(data => {
                ...
                // const queryURL = `https://api.open-meteo.com/v1/forecast?latitude=${lat}&longitude=${long}&current=temperature_2m,weather_code&hourly=temperature_2m,relative_humidity_2m,weather_code&daily=weather_code,temperature_2m_max,temperature_2m_min&timezone=auto`
                ...
                fetch(queryURL)
                    ...
                    .then(data => {
                        ...
                        console.log(`Your current city is: ${currentCity}`);
